...
test_page "/users" "User Intelligence Directory"
test_page "/users/$USER_NAME/overview" "User Overview Tab"
test_page "/users/$USER_NAME/activity" "User Activity & Performance Tab"
test_page "/users/$USER_NAME/topology" "User Access & Topology Tab"
test_page "/users/$USER_NAME/changes" "User Behavior Changes Tab"
test_page "/users/$USER_NAME/patterns" "User Usage Patterns Tab"
test_page "/users/$USER_NAME/investigations" "User Anomalies & Investigations Tab"
test_page "/unknown-users" "Unknown & Unauthenticated Users Page"
...
test_api "/api/v1/users/$USER_NAME/performance" "User Performance Time-Series & 5m KPIs"
test_api "/api/v1/users/$USER_NAME/topology" "User Topology Paths & Operations"
test_api "/api/v1/users/$USER_NAME/investigations" "User Investigations & Before-vs-Now"
...
test_api "/api/v1/unknown-users" "Unknown Users Analytics & Traffic KPIs"
