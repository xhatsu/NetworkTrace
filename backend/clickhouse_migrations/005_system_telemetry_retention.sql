...
--     metric_log, asynchronous_metric_log: 3 days TTL
--   - error_log: 7 days TTL

ALTER TABLE system.text_log MODIFY TTL event_date + toIntervalDay(3);
ALTER TABLE system.query_log MODIFY TTL event_date + toIntervalDay(3);
ALTER TABLE system.processors_profile_log MODIFY TTL event_date + toIntervalDay(3);
...
ALTER TABLE system.error_log MODIFY TTL event_date + toIntervalDay(7);
